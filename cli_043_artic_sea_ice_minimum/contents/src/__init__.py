...
CARTO_SCHEMA = OrderedDict([
    ...
    ('date_area', 'timestamp'),
    ('extent', 'numeric'),
    ('date_extent', 'timestamp')])
UID_FIELD_AREA = 'date_area'
TIME_FIELD_AREA = 'date_area'
UID_FIELD_EXTENT = 'date_extent'
TIME_FIELD_EXTENT = 'date_extent'
